...
def create_dashboard():
    ...
    # -----------------------------
    plt.subplot(2, 2, 1)
    plt.bar(df["stud_name"], df["sub_mark"], color="orange")
    ...
    # -----------------------------
    # 4. Subject Average Marks
    # -----------------------------
    plt.subplot(2, 2, 4)
    avg_marks = df.groupby("sub_name")["sub_mark"].mean()
